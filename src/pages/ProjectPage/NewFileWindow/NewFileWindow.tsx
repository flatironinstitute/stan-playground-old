...
const options = [
    {name: 'stan', extension: '.stan', label: 'Stan program', defaultFileName: 'main.stan', defaultText: defaultStanProgram},
    ...
    {name: 'spa', extension: '.spa', label: 'Analysis', defaultFileName: 'main.spa', defaultText: defaultSpaYaml},
